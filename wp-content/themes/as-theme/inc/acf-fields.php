...
array(
    ...
    // Why Aspire Group Section Field Group
    acf_add_local_field_group(array(
        'key' => 'group_why_aspire_section',
        'title' => 'Why Aspire Group Section',
        'fields' => array(
            array(
                'key' => 'field_why_aspire_title',
                'label' => 'Section Title',
                'name' => 'why_aspire_title',
                'type' => 'text',
                'default_value' => 'Why Aspire Group?',
            ),
            array(
                'key' => 'field_why_aspire_features',
                'label' => 'Features',
                'name' => 'why_aspire_features',
                'type' => 'repeater',
                'min' => 1,
                'max' => 12,
                'layout' => 'block',
                ...
                'sub_fields' => array(
                    array(
                        'key' => 'field_why_aspire_feature_icon',
                        'label' => 'Icon (SVG or Image)',
                        'name' => 'icon',
                        'type' => 'image',
                        'return_format' => 'url',
                        'mime_types' => 'svg,png,jpg,jpeg,webp',
                        'instructions' => 'Upload an SVG (preferred) or image icon.',
                    ),
                    array(
                        'key' => 'field_why_aspire_feature_icon_svg',
                        'label' => 'Inline SVG (optional)',
                        'name' => 'icon_svg',
                        'type' => 'textarea',
                        'instructions' => 'Optional: paste inline SVG markup here. If present, this overrides the uploaded icon.',
                        'rows' => 4,
                    ),
                    array(
                        'key' => 'field_why_aspire_feature_title',
                        'label' => 'Title',
                        'name' => 'title',
                        'type' => 'text',
                    ),
                    array(
                        'key' => 'field_why_aspire_feature_description',
                        'label' => 'Description',
                        'name' => 'description',
                        'type' => 'textarea',
                        'rows' => 3,
